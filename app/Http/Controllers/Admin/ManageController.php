...
use App\Support\Patterns\Abstracts\DatabaseConnector as Repository;
...
class ManageController extends Controller
{
    ...
    public function index()
    {
        ...
        $newUsers = $this->userService->countNewUsersSince(now()->subDay());
    ...
    public function update(Request $request)
    {
        ...
        $updated = $this->userService->update(
            $editUserId = $request->input('editUserId'),$data
        );
    ...
    {
        $users = $this->userService->getAll(); 
        $pdf = $this->pdfService->generate('pdf.users', compact('users'));
